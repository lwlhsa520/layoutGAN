...
if __name__ == "__main__":
    ...
    training_set = ImageFolderDataset(path='../data/dataset', use_labels=False, bbox_dim=256, max_size=None, xflip=False, aug=False)
    ...
    gen_imgs1, gen_masks1, _, _ = G(z1, bboxs)
    gen_imgs2, gen_masks2, _, _ = G(z2, bboxs)
    gen_imgs3, gen_masks3, _, _ = G(z3, bboxs)
    ...
    for idx, (g_img1, g_img2, g_mask1, g_mask2, img, msk, bbx) in enumerate(zip(gen_imgs1, gen_imgs2, gen_masks1, gen_masks2, images, masks, bboxs)):
        ...
        #lab = bbx[2]
            ...
            cv2.rectangle(g_img1[0],(lab[1], lab[2]), (lab[3], lab[4]), (255, 0, 0))
            cv2.rectangle(g_img2[0],(lab[1], lab[2]), (lab[3], lab[4]), (255, 0, 0))
